...
class ParentsControllerTest < ActionController::TestCase
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post :create, parent: { gender--no-test-framewor: @parent.gender--no-test-framewor, name: @parent.name }
    end
  ...
  test "should update parent" do
    patch :update, id: @parent, parent: { gender--no-test-framewor: @parent.gender--no-test-framewor, name: @parent.name }
    assert_redirected_to parent_path(assigns(:parent))
  end
